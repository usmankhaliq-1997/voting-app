<x-app-layout>
    ...
    <div class="buttons-container flex justify-between mt-6">
        ...
        <div class="flex items-center space-x-2 ml-4">
            <button type="submit"
                class="flex items-center justify-center w-32 h-11 text-xs bg-blue-600 text-white font-semibold rounded-xl border border-gray-200 hover:border-gray-400 hover:transition duration-150 ease-in px-6 py-3">
